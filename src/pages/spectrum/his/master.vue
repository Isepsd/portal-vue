...
const filterValues = ref<any>({
  page: 1,
  limit: 10,
  id_induk_pointtype: "3fc4d6b6-6faf-4089-a020-344d16ad4208", kinerja: 1 ,
...
<VCol cols="12">
  <AppCardCode title="Filter" :code="{ ts: '', js: '' }">
    <div class="mt-6">
      <FillterFasopRTUhistoryMasterdata :onFilterChange="handleFilterChange" />
    </div>
  </AppCardCode>
</VCol>
    ...
    <TableIgrid
      ...
      :pathService="API_PATH().fasop.history.digital"
