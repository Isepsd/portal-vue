...
// 🟢 API Service
const pathService = API_PATH().admin.role
...
const columnDefs = ref([
  ...
  { headerName: 'Nama Role', field: 'name', flex: 1 },
  { headerName: 'Deskripsi', field: 'description', flex: 1 },
    ...
    cellRenderer: (params:any) => {
      ...
      return `
        <div style="display:flex; gap:6px;">
          ...
          <button class="btn-action btn-privilege" data-id="${row.id}">Privilege</button>
