...
import { default as authV2LoginIllustrationBorderedDark, default as authV2LoginIllustrationDark } from '@images/pages/auth-v2-login-illustration-bordered-darknew.png';
