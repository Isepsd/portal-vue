...
const handleEdit = (item: any) => {
  router.push(`/masteropsisdis/subfasilitas/edit/${item.id}`)
}

const handleAdd = () => {
  router.push('/masteropsisdis/subfasilitas/tambah')
}

onMounted(() => {
  const roleAccess: any = ROLE_ACCESS('sub-fasilitas')
 ...
 <!-- Header -->
  <VCard class="header-card mb-6 pa-4">
    <VRow class="align-center">
      ...
      <VCol cols="12" md="8" class="d-flex align-start">
        ...
        <div class="header-info">
          <h2 class="header-title">Sub Fasilitas</h2>
    ...
    <TableIgrid
      ...
      :pathService="API_PATH().master.opsisdis.rekap_padam.sub_fasilitas"
