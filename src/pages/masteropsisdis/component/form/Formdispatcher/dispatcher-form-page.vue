...
import { IndikasiField } from '@/pages/masteropsisdis/component/interface/jaringan-jenis-pembangkit.interface'
...
// PILIHAN JENIS (STATIC)
const jenisOptions = ref([
  { text: 'DISPA', value: 'DISPA' },
  { text: 'CC', value: 'CC' }
])
...
const handleFormSubmit = (result: any) => {
  if (result.success) {
    ...
    showNotification(`Sukses ${action} data Dispatcher`, 'success')
  } else {
...
// Initialize
onMounted(async () => {
  console.log('Dispatcher form mounted')
})
</script>
...
<template>
  ...
  <FormData
    ...
    :path="API_PATH().master.opsisdis.rekap_padam.petugas"
    custom-label="Dispatcher"
      ...
      <VRow class="match-height">
        ...
        <VCol cols="12" md="7">
          <VTextField
            ...
            placeholder="Masukkan Nama Dispatcher"
