...
const handleFormSubmit = (result: any) => {
  if (result.success) {
    ...
    showNotification(`Sukses ${action} data Sub Fasilitas`, 'success')
  } else {
...
// Initialize
onMounted(async () => {
  console.log('Sub Fasilitas form mounted')
})
</script>
...
<template>
  ...
  <FormData
    ...
    :path="API_PATH().master.opsisdis.rekap_padam.sub_fasilitas"
    custom-label="Sub Fasilitas"
