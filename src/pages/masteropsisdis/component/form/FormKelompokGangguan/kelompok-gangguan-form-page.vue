...
// Initialize
onMounted(async () => {
  console.log('Kelompok Gangguan form mounted')
})
</script>
...
<template>
  ...
  <FormData
    ...
    :path="API_PATH().master.opsisdis.rekap_padam.kelompok_penyebab"
    custom-label="Kelompok Gangguan"
    ...
    <template #default="{ form, loading, errors, fetchDynamicData, validateForm, submitForm }">
      <VRow class="match-height">
        ...
        <VCol cols="12" md="7">
          <VTextField
            v-model="form.nama"
            label="Nama Kelompok Gangguan *"
            placeholder="Masukkan Nama Kelompok Gangguan"
