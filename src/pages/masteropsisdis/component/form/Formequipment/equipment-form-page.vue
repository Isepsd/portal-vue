...
const handleFormSubmit = (result: any) => {
  if (result.success) {
    ...
    showNotification(`Sukses ${action} data Equipment`, 'success')
  } else {
...
// Initialize
onMounted(async () => {
  console.log('Equipment form mounted')
})
</script>
...
<template>
  ...
  <FormData
    ...
    :path="API_PATH().master.opsisdis.rekap_padam.peralatan"
    custom-label="Equipment"
