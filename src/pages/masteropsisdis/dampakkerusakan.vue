...
const handleEdit = (item: any) => {
  router.push(`/masteropsisdis/dampakkerusakan/edit/${item.id}`)
}

const handleAdd = () => {
  router.push('/masteropsisdis/dampakkerusakan/tambah')
}
 ...
 <!-- Header -->
  <VCard class="header-card mb-6 pa-4">
    <VRow class="align-center">
      ...
      <VCol cols="12" md="8" class="d-flex align-start">
        ...
        <div class="header-info">
          <h2 class="header-title">Dampak Kerusakan</h2>
    ...
    <TableIgrid
      ...
      :pathService="API_PATH().master.opsisdis.rekap_padam.dampak_kerusakan"
