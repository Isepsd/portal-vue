...
const handleEdit = (item: any) => {
  router.push(`/masteropsisdis/cuaca/edit/${item.id}`)
}

const handleAdd = () => {
  router.push('/masteropsisdis/cuaca/tambah')
}

onMounted(() => {
  const roleAccess: any = ROLE_ACCESS('cuaca')
 ...
 <!-- Header -->
  <VCard class="header-card mb-6 pa-4">
    <VRow class="align-center">
      ...
      <VCol cols="12" md="8" class="d-flex align-start">
        ...
        <div class="header-info">
          <h2 class="header-title">Cuaca</h2>
    ...
    <TableIgrid
      ...
      :pathService="API_PATH().master.opsisdis.rekap_padam.cuaca"
