...
const handleEdit = (item: any) => {
  router.push(`/masteropsisdis/fasilitas/edit/${item.id}`)
}

const handleAdd = () => {
  router.push('/masteropsisdis/fasilitas/tambah')
}
 ...
 <!-- Header -->
  <VCard class="header-card mb-6 pa-4">
    ...
    <TableIgrid
      ...
      :pathService="API_PATH().master.opsisdis.rekap_padam.fasilitas"
