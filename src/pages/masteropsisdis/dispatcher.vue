...
import { INDIKASI_COLUMNS } from './component/columnref/pembangkit.config'
...
const columnDefs = ref(INDIKASI_COLUMNS())
...
const handleEdit = (item: any) => {
  router.push(`/masteropsisdis/dispatcher/edit/${item.id}`)
}

const handleAdd = () => {
  router.push('/masteropsisdis/dispatcher/tambah')
}

onMounted(() => {
  const roleAccess: any = ROLE_ACCESS('dispatcher')
 ...
 <!-- Header -->
  <VCard class="header-card mb-6 pa-4">
    <VRow class="align-center">
      ...
      <VCol cols="12" md="8" class="d-flex align-start">
        ...
        <div class="header-info">
          <h2 class="header-title">Dispatcher</h2>
    ...
    <TableIgrid
      ...
      :pathService="API_PATH().master.opsisdis.rekap_padam.petugas"
