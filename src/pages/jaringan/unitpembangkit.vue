...
const handleEdit = (item: any) => {
  router.push(`/jaringan/unitpembangkit/edit/${item.id_ref_lokasi}`)
}

const handleAdd = () => {
  router.push('/jaringan/unitpembangkit/tambah')
}

onMounted(() => {
  const roleAccess: any = ROLE_ACCESS('unitpembangkit')
    ...
    <VRow class="align-center">
      ...
      <VCol cols="12" md="8" class="d-flex align-start">
        ...
        <div class="header-info">
          <h2 class="header-title">Unit Pembangkit</h2>
